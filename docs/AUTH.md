# Marquee authentication contract

## Authority

KpnCompute MJCC is the central identity authority for manager accounts. Marquee
...
1. The Marquee login screen presents **Continue with MJCC**.
...
4. The browser returns to Marquee with the code in the URL fragment, then
   immediately removes it from browser history.
5. The Marquee Edge Function sends the code to the KpnCompute exchange endpoint
